  ...
  return (
    <section className="section">
      ...
      <div className="container">
        ...
        <div className="div">
          <Image src={joojeh} className="image" />
          <div className="div2">
        ...
        <div className="div">
          <Image src={kubide} className="image" />
          <div className="div2">
        ...
        <div className="div">
          <Image src={beryani} className="image" />
          <div className="div2">
        ...
        <div className="div">
          <Image src={ghaliye} className="image" />
          <div className="div2">
        ...
        <div className="div">
          <Image src={ghormesabzi} className="image" />
          <div className="div2">
        ...
        <div className="div">
          <Image src={fesenjan} className="image" />
          <div className="div2">
        ...
        <div className="div">
          <Image src={khoreshtkarafs} className="image" />
          <div className="div2">
        ...
        <div className="div">
          <Image src={aschreschte} className="image" />
          <div className="div2">
